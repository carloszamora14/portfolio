      ...
      <section className="container">
        <Paragraph title="Problem">
          <p style={{ fontSize: '1rem', lineHeight: '150%' }}>
            In today&apos;s world, excessive time spent on social media has led
            to a gradual loss of assertiveness in human interactions, negatively
            impacting both personal and professional communication. This has
            resulted in more conflicts, making it essential to educate people
            with tools for effective communication. The pandemic worsened this
            issue by reducing social interaction and increasing depression and
            anxiety. Learning to manage emotions has become vital for personal
            success. This app provides users with practical and theoretical
            resources to develop emotional intelligence, helping them improve
            their social skills.
          </p>
        </Paragraph>
        <Paragraph title="Our solution">
          <p style={{ marginTop: '1rem', fontSize: '1rem', lineHeight: '150%' }}>
            A mobile application specifically designed for learning and
            enhancing emotional intelligence. Users will have access to a
            variety of carefully selected resources, including relevant
            information and practical exercises. The primary goal of the
            application is to improve interpersonal relationships by helping
            users understand and manage their emotions effectively.
          </p>
